...
public class MenuController extends AbstractCmsController {
	...
	public String edit(@PathVariable("id") String id,
			@RequestParam("page") String page, @ModelAttribute Menu menu)
			throws Exception {
	...
	public String create(@RequestParam String page, Menu menu) throws Exception {
		SitePage sitePage = sitePageRepository.findOne(page);
		menu.setPage(sitePage);
		if (!isValid(menu))
			throw new Exception(
	...
	public String moveDown(@PathVariable String menuId) {
	...
	public String moveUo(@PathVariable String menuId) {
		Menu menu = menuRepository.findOne(menuId);
